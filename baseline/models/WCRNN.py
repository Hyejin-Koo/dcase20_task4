...
from models.wav2vec2 import Wav2Vec2Model as w2v_encoder
from models.wav2vec2 import Wav2Vec2Config
from models.wav2vec2_asr import Wav2Vec2AsrConfig as Wav2Vec2SedConfig
from models.wav2vec2_asr import Wav2VecEncoder
...
## @dataclass
#class Wav2Vec2SedConfig(FairseqDataclass):
#    pass
...
class WCRNN(nn.Module): #, BaseFairseqModel):
    ...
    def state_dict(self, destination=None, prefix='', keep_vars=False):
        state_dict = {"w2v": self.w2v.state_dict(destination=destination, prefix=prefix, keep_vars=keep_vars),
