...
class Wav2Vec2AsrConfig(FairseqDataclass):
    w2v_path: str = field(
        default='/home1/irteam/users/koo/share/model/checkpoint.pt', metadata={"help": "path to wav2vec 2.0 model"}
    )
...
@register_model("wav2vec_encoder_sed", dataclass=Wav2Vec2CtcConfig)
...
@register_model("wav2vec_seq2seq_sed", dataclass=Wav2Vec2Seq2SeqConfig)
